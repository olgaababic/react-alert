  ...
  _createClass(ReactAlert, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement(_reactBootstrap.Modal, {
        ...
        className: "pull-right glyphicon glyphicon-calendar",
        ...
        onClick: function onClick() {
          return _this.props.successButtonCallBack().then(function () {
        ...
        onClick: function onClick() {
          return _this.props.cancelButtonCallBack().then(function () {
            if (_this.props.closeAfterAction) {
              _this.props.closeModal();
            }
          });
...
(0, _reactDom.render)(_react.default.createElement(ReactAlert, null), document.getElementById("app"));