...
function (_Component) {
  function ReactAlert(props) {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(ReactAlert).call(this, props));
  }
  ...
  _createClass(ReactAlert, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement(_reactBootstrap.Modal, {
        ...
        className: this.props.modalContentClassName,
        style: this.props.modelContentStyle
      ...
      }, this.props.title, _react.default.createElement("button", {
        type: "button",
        className: "close"
  ...
  _inherits(ReactAlert, _Component);
